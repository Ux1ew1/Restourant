    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center gap-2 rounded-xl border border-vanilla-200 px-4 py-2 text-sm font-medium text-vanilla-700 transition hover:bg-vanilla-100 disabled:opacity-60"
        >
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        <button
          ...
          className={`rounded-xl border px-3.5 py-1.5 text-xs font-semibold transition ${statusFilter === "all" ? "border-vanilla-500 bg-vanilla-500 text-white" : "border-vanilla-200 text-vanilla-600 hover:bg-vanilla-100"}`}
        >
          Все
        </button>
        {ORDER_STATUSES.map((s) => (
          <button
            ...
            className={`rounded-xl border px-3.5 py-1.5 text-xs font-semibold transition ${statusFilter === s.value ? "border-vanilla-500 bg-vanilla-500 text-white" : "border-vanilla-200 text-vanilla-600 hover:bg-vanilla-100"}`}
          >
            {s.label}
          </button>
        ))}
      ...
      {totalPages > 1 && (
        <div className="mt-6 flex items-center justify-center gap-2">
          <button
            ...
            className="rounded-xl border border-vanilla-200 px-4 py-2 text-sm disabled:opacity-40"
          >
            ← Назад
          </button>
